...
lyr_Kbenhavn_34.setZIndex(9999);
lyr_Kbenhavn_34.setVisible(true);
lyr_Kbenhavn_34.set('title', '');
map.addLayer(lyr_Kbenhavn_34);


//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit(
    [1377052.250713, 7476427.373433, 1426171.729869, 7510504.903266],
